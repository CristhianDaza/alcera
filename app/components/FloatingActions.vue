...
const telegramUrl = computed(() => {
  if (!store.value.telegramEnabled) return "";
...
function trackTelegramClick() {
  void trackAnalyticsEvent("telegram_click", {
    link_location: "floating_button",
    page_path: route.fullPath,
  });
}
...
<template>
  <div class="floating-actions" aria-label="Acciones rápidas">
    ...
    <div v-if="whatsappUrl || telegramUrl" class="floating-contact-actions">
      <a
        v-if="telegramUrl"
        class="floating-button floating-button--telegram"
        :href="telegramUrl"
        target="_blank"
      ...
      >
        <svg viewBox="0 0 24 24" aria-hidden="true">
          <path
            d="M21.7 2.4 2.8 9.7c-1.3.5-1.3 1.2-.2 1.5l4.8 1.5 1.9 5.8c.2.6.1.9.8.9.5 0 .8-.2 1-.4l2.3-2.2 4.8 3.5c.9.5 1.5.3 1.8-.8l3.2-15.2c.4-1.4-.5-2.1-1.5-1.9ZM8.2 12.4l10.9-6.9c.5-.3 1-.1.6.2l-9 8.1-.3 3.4-2.2-4.8Z"
          />
        </svg>
        <span>Telegram</span>
      </a>
